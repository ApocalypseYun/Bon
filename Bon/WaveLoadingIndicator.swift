...
class WaveLoadingIndicator: UIView {
    ...
    fileprivate let heavyColor = UIColor(red: 128/255.0, green: 119/255.0, blue: 137/255.0, alpha: 1.0)
    fileprivate let lightColor = UIColor(red: 148/255.0, green: 141/255.0, blue: 157/255.0, alpha: 1.0)
    fileprivate let clipCircleColor = UIColor(red: 128/255.0, green: 119/255.0, blue: 137/255.0, alpha: 1.0)
...
//    private let clipCircleColor = UIColor(red: 38/255.0, green: 227/255.0, blue: 198/255.0, alpha: 1.0)
    ...
    fileprivate var clipCircleLineWidth: CGFloat = 3
    
    fileprivate let progressTextFontSize: CGFloat = 20.0

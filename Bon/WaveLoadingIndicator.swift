...
class WaveLoadingIndicator: UIView {
    ...
    private let heavyColor = UIColor(red: 128/255.0, green: 119/255.0, blue: 137/255.0, alpha: 1.0)
    private let lightColor = UIColor(red: 148/255.0, green: 141/255.0, blue: 157/255.0, alpha: 1.0)
    private let clipCircleColor = UIColor(red: 128/255.0, green: 119/255.0, blue: 137/255.0, alpha: 1.0)
...
//    private let clipCircleColor = UIColor(red: 38/255.0, green: 227/255.0, blue: 198/255.0, alpha: 1.0)
    ...
    private var clipCircleLineWidth: CGFloat = 3
    
    private let progressTextFontSize: CGFloat = 20.0
